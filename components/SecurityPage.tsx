...
const SecurityPage: React.FC<SecurityPageProps> = ({ onBackHome }) => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: "The speed with which they identified and neutralized complex lateral movement threats was astonishing. Their automated SOC integration has saved us hundreds of man-hours and prevented multiple high-value breaches.",
      logo: (
      ...
      <section className="relative min-h-[500px] flex items-center overflow-hidden bg-gradient-to-r from-[#00055c] via-[#000d8c] to-[#0019ff] py-32 px-6 lg:px-12">
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[50%] h-full opacity-40 pointer-events-none">
          <svg width="100%" height="100%" viewBox="0 0 400 400" preserveAspectRatio="none">
            <pattern id="dotPatternSecurity" x="0" y="0" width="16" height="16" patternUnits="userSpaceOnUse">
              <circle cx="2" cy="2" r="1.5" fill="white" />
            </pattern>
            <rect width="100%" height="100%" fill="url(#dotPatternSecurity)" mask="url(#fadeMaskSec)" />
            <defs>
              <linearGradient id="fadeGradientSec" x1="0" y1="0" x2="1" y2="0">
                <stop offset="0%" stopColor="black" />
                <stop offset="100%" stopColor="white" />
              </linearGradient>
              <mask id="fadeMaskSec">
                <rect width="100%" height="100%" fill="url(#fadeGradientSec)" />
              </mask>
            </defs>
          </svg>
        </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-stretch">
          <div className="flex-[1.2]">
            <h2 className="text-4xl md:text-[54px] font-black text-[#1a1b1f] leading-[1.05] tracking-tight mb-8">
              Why leave your <br /> data exposed?
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
              {[
                { title: 'Proactive Defense', desc: 'Identify and fix vulnerabilities before they can be exploited by malicious actors.' },
                { title: 'Identity First', desc: 'Robust IAM protocols that ensure only authorized personnel access sensitive data.' },
                { title: 'Continuous Audits', desc: 'Regular security assessments to ensure ongoing compliance with global standards.' },
                { title: 'Resilient Recovery', desc: 'Advanced backup and recovery systems to restore operations instantly after an incident.' }
              ].map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
              {[
                { title: 'Audit & Blueprint', desc: 'Mapping your entire attack surface and identifying critical technical gaps.', icon: <Eye size={24} /> },
                { title: 'Fortification', desc: 'Deploying multi-layered defenses and automated response protocols.', icon: <Shield size={24} /> },
                { title: 'Active Monitoring', desc: '24/7 human and AI-led oversight to identify and neutralize threats.', icon: <Zap size={24} /> }
              ].map((item, idx) => (
      ...
      <section className="py-32 bg-[#f8faff] px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: 'Cloud Fortification', icon: <Server size={32} />, desc: 'Native security configurations for AWS, Azure, and Google Cloud.' },
              { title: 'Endpoint Protection', icon: <HardDrive size={32} />, desc: 'Securing every laptop, server, and IoT device in your network.' },
              { title: 'User Verification', icon: <UserCheck size={32} />, desc: 'Next-gen biometric and multi-factor authentication systems.' }
            ].map((service, idx) => (
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-start">
            <div className="flex-1 lg:sticky lg:top-40">
              <h2 className="text-4xl md:text-[54px] font-black text-[#1a1b1f] leading-[1.1] tracking-tighter mb-10">
                Precision Defense <br /> engineering
              </h2>
          ...
          <div className="flex-1 bg-white p-12 md:p-16">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea rows={4} placeholder="Tell us about your security goals..." className="w-full px-5 py-4 bg-white border border-gray-200 rounded-lg focus:border-[#001fcc] focus:ring-1 focus:ring-[#001fcc] outline-none transition-all resize-none"></textarea>
              </div>
