...
const CustomSoftwarePage: React.FC<CustomSoftwarePageProps> = ({ onBackHome, onNavigateHome }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Banner Section - This now starts immediately after the Navbar */}
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row-reverse gap-16 lg:gap-24 items-stretch">
          <div className="flex-[1.2]">
            ...
            <div className="space-y-8">
              {[
                { title: 'Scalable Infrastructure', desc: 'As your business grows, your IT needs to grow with it. We build systems that scale effortlessly from 10 to 1,000+ users.' },
                { title: 'Advanced Threat Protection', desc: 'In an era of rising cyber threats, we implement multi-layered security protocols to safeguard your intellectual property.' },
                { title: 'Dedicated Helpdesk', desc: 'Our experts are always a call away, ensuring that your team stays productive without technical hurdles.' }
              ].map((item, idx) => (
                <div key={idx} className="flex gap-6 group">
                   <div className="w-14 h-14 bg-[#e8edff] rounded-2xl flex items-center justify-center text-[#001fcc] shrink-0 group-hover:bg-[#001fcc] group-hover:text-white transition-all duration-300">
                      {idx === 0 ? <Globe size={24} /> : idx === 1 ? <Shield size={24} /> : <Cpu size={24} />}
                   </div>
                   <div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto font-medium">
              Our holistic approach ensures that every aspect of your software is optimized for performance, security, and user experience.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: 'Cloud Integration', icon: <Globe size={32} />, desc: 'Leverage the power of distributed systems for ultimate scalability.' },
              { title: 'Cyber Security', icon: <Shield size={32} />, desc: 'Enterprise-grade protection built into the core of your application.' },
              { title: 'Mobile First', icon: <Smartphone size={32} />, desc: 'Optimized experiences for users on the go, across all devices.' }
            ].map((service, idx) => (
      ...
      <section className="bg-white px-6 pb-32 pt-16">
        <div className="max-w-7xl mx-auto rounded-[3rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row min-h-[800px]">
          ...
          <div className="flex-1 bg-white p-12 md:p-16" data-consultation-form>
            <div className="text-center mb-10">
              <h3 className="text-[#1a1b1f] text-3xl font-black mb-2">Schedule a Free Consultation</h3>
              <button onClick={onNavigateHome} className="w-full bg-[#001fcc] text-white font-bold py-4 rounded-lg hover:bg-blue-700 transition-colors cursor-pointer mt-6">Get Started</button>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:max-w-xl">
            ...
            <ul className="space-y-6">
              {[
                'Strict NDA compliance for all projects',
                'Agile methodology for transparent delivery',
          ...
          <div className="grid grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-black text-[#001fcc] mb-2 tracking-tighter">200+</div>
              <div className="text-xs font-black uppercase tracking-[0.2em] text-gray-400">Project Delivery</div>
            </div>
          </div>
        </div>
      </section>
