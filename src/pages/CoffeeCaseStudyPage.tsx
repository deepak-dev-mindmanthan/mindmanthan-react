      ...
      <section className="bg-white pt-40 pb-20 px-6 lg:px-12 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="inline-block px-3 py-1 bg-[#f1f5f9] rounded-md mb-8">
            <span className="text-[#64748b] text-[11px] font-black uppercase tracking-[0.2em]">IoT + Automation</span>
          </div>
          ...
          <p className="text-gray-500 max-w-3xl text-lg">
            We connected device telemetry, production data, and workflow automation into one unified system.
          </p>
        </div>
      </section>
      ...
      <div className="border-y border-gray-100 py-6 px-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-[12px] font-black uppercase tracking-widest text-gray-400">
          ...
          <div className="flex gap-4 items-center">
            ...
            <span className="text-[#1a1b1f]">IoT Operations</span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16">
          <div>
            ...
            <ul className="space-y-4 text-gray-600 text-lg">
              <li>IoT sensor integration with secure edge-to-cloud data flow</li>
              <li>Real-time dashboards for production, alerts, and KPI tracking</li>
              <li>Automated reporting for supervisors and leadership teams</li>
              <li>Mobile companion app for field teams</li>
              <li>Cloud deployment and monitoring with long-term technical support</li>
            </ul>
          </div>
          <div className="rounded-3xl overflow-hidden border border-gray-100 shadow-lg">
            <img loading="lazy" decoding="async"
              src="https://images.unsplash.com/photo-1581092160607-ee22731c73d5?q=80&w=1200&auto=format&fit=crop"
