...
const PROJECTS: Project[] = [
  { id: '1', title: 'Enterprise HRMS Platform', category: 'Custom Software', image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?q=90&w=1600&auto=format&fit=crop', bgColor: '#e0e7ff' },
  { id: '2', title: 'Corporate Website Suite', category: 'Web Development', image: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=90&w=1600&auto=format&fit=crop', bgColor: '#fdf6e3' },
  { id: '3', title: 'Field Operations Mobile App', category: 'Mobile App', image: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=90&w=1600&auto=format&fit=crop', bgColor: '#1a1b1f' },
  { id: '4', title: 'IoT Asset Monitoring Dashboard', category: 'IoT', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?q=90&w=1600&auto=format&fit=crop', bgColor: '#ecfdf5' },
  { id: '5', title: 'Cloud DevOps Modernization', category: 'Cloud & DevOps', image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=90&w=1600&auto=format&fit=crop', bgColor: '#fff1f2' },
  { id: '6', title: 'API Integration Hub', category: 'API', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=90&w=1600&auto=format&fit=crop', bgColor: '#f0f9ff' },
];
