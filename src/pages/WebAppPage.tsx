    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[500px] flex items-center overflow-hidden bg-gradient-to-r from-[#00055c] via-[#000d8c] to-[#0019ff] py-32 px-6 lg:px-12">
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[50%] h-full opacity-40 pointer-events-none">
          <svg width="100%" height="100%" viewBox="0 0 400 400" preserveAspectRatio="none">
            ...
            <rect width="100%" height="100%" fill="url(#dotPatternWeb)" mask="url(#fadeMaskWeb)" />
            <defs>
              <linearGradient id="fadeGradientWeb" x1="0" y1="0" x2="1" y2="0">
                <stop offset="0%" stopColor="black" />
                <stop offset="100%" stopColor="white" />
              </linearGradient>
              <mask id="fadeMaskWeb">
                <rect width="100%" height="100%" fill="url(#fadeGradientWeb)" />
              </mask>
            </defs>
          </svg>
        </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-stretch">
          <div className="flex-[1.2]">
            <h2 className="text-4xl md:text-[54px] font-black text-[#1a1b1f] leading-[1.05] tracking-tight mb-8">
              Why settle for slow <br /> legacy systems?
            </h2>
            <p className="text-gray-500 text-[18px] leading-relaxed mb-8 font-medium max-w-2xl">
              Outdated web infrastructure is the number one cause of lost revenue and user frustration. Our modern web application development allows you to build a competitive edge:
            </p>
            
            <ul className="space-y-4 mb-16">
              {[
                "Deploy lightning-fast applications using React and Next.js.",
                "Ensure maximum uptime with cloud-native distributed architecture.",
                "Protect sensitive user data with enterprise-grade encryption.",
                "Scale effortlessly from 1,000 to 1 million concurrent users."
              ].map((item, idx) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
              {[
                { title: 'Modern Tech Stacks', desc: 'We utilize TypeScript, React, Node, and Go to build future-proof web ecosystems.' },
                { title: 'Global Scalability', desc: 'Deploy across multiple regions with low latency using advanced edge computing.' },
                { title: 'PWA Ready', desc: 'Transform your web app into a native-like experience with offline capabilities.' },
                { title: 'API-First Design', desc: 'Build flexible backends that power web, mobile, and third-party integrations.' }
              ].map((item, idx) => (
      ...
      <section className="bg-white py-32 px-6 lg:px-12 border-t border-gray-50">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row-reverse gap-16 lg:gap-24 items-stretch">
          <div className="flex-[1.2]">
            <h2 className="text-4xl md:text-[54px] font-black text-[#1a1b1f] leading-[1.05] tracking-tight mb-8">
              Precision Engineering <br /> Lifecycle
            </h2>
            <p className="text-gray-500 text-[18px] leading-relaxed mb-12 font-medium max-w-2xl">
              We don't just write code—we engineer solutions. Our web development model is designed to align with your business goals and technical standards from day one.
            </p>
            
            <div className="space-y-8">
              {[
                { title: 'Architecture First', desc: 'We design robust system architectures that prevent technical debt and allow for rapid future expansion.' },
                { title: 'UX/UI Alignment', desc: 'Our developers work closely with designers to ensure pixel-perfect implementation of complex user flows.' },
                { title: 'Continuous Delivery', desc: 'Integrated CI/CD pipelines ensure that new features are deployed safely and frequently.' }
              ].map((item, idx) => (
                <div key={idx} className="flex gap-6 group">
                   <div className="w-14 h-14 bg-[#e8edff] rounded-2xl flex items-center justify-center text-[#001fcc] shrink-0 group-hover:bg-[#001fcc] group-hover:text-white transition-all duration-300">
                      {idx === 0 ? <Code size={24} /> : idx === 1 ? <Layout size={24} /> : <Globe size={24} />}
                   </div>
                   <div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto font-medium">
              We leverage the most advanced web technologies to build complex, data-driven applications that outperform the competition.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: 'Frontend Systems', icon: <Monitor size={32} />, desc: 'Modern React, Vue, and Next.js applications with blazing fast load times.' },
              { title: 'Backend Power', icon: <Cpu size={32} />, desc: 'Robust Node.js, Go, and Python microservices built for maximum concurrency.' },
              { title: 'Data & Security', icon: <Shield size={32} />, desc: 'PostgreSQL, Redis, and advanced OAuth2 implementations for data integrity.' }
            ].map((service, idx) => (
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-start">
            <div className="flex-1 lg:sticky lg:top-40">
              <h2 className="text-4xl md:text-[54px] font-black text-[#1a1b1f] leading-[1.1] tracking-tighter mb-10">
                End-to-end web <br /> application delivery
              </h2>
              <p className="text-gray-500 text-[19px] leading-relaxed max-w-md font-medium">
                We handle every technical layer of your platform. From database normalization to frontend state management, we build it right.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto rounded-[3rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row min-h-[800px]">
          ...
          <div className="flex-1 bg-white p-12 md:p-16">
            <div className="text-center mb-10">
              <h3 className="text-[#1a1b1f] text-3xl font-black mb-2">Start Your Web Project</h3>
            ...
            <form className="space-y-6">
              ...
              <div>
                <label className="block text-[13px] font-bold text-gray-600 uppercase tracking-widest mb-2">Platform Type</label>
                <select aria-label="Form selection" className="w-full px-5 py-4 bg-white border border-gray-200 rounded-lg focus:border-[#001fcc] focus:ring-1 focus:ring-[#001fcc] outline-none transition-all appearance-none cursor-pointer">
                  ...
                  <option>Custom CMS / Portal</option>
                  <option>E-commerce Solution</option>
                  <option>Internal Business Tool</option>
                  <option>Other Web Platform</option>
                </select>
              </div>

              <div>
                <label className="block text-[13px] font-bold text-gray-600 uppercase tracking-widest mb-2">Project Brief</label>
                <textarea aria-label="Form message" rows={4} placeholder="Describe your vision, target audience, and key required features..." className="w-full px-5 py-4 bg-white border border-gray-200 rounded-lg focus:border-[#001fcc] focus:ring-1 focus:ring-[#001fcc] outline-none transition-all resize-none"></textarea>
              </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:max-w-xl">
            ...
            <ul className="space-y-6">
              {[
                ...
                'Strict compliance with ISO security standards',
          ...
          <div className="grid grid-cols-2 gap-8 lg:gap-16">
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-black text-[#001fcc] mb-2 tracking-tighter">150+</div>
              <div className="text-xs font-black uppercase tracking-[0.2em] text-gray-400">Web Apps Delivered</div>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-black text-[#001fcc] mb-2 tracking-tighter">12M+</div>
              <div className="text-xs font-black uppercase tracking-[0.2em] text-gray-400">End Users Reached</div>
            </div>
          </div>
        </div>
      </section>
