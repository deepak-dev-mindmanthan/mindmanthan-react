...
const BlockchainTechItem: React.FC<{ title: string; index: number }> = ({ title, index }) => {
    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="text-gray-500 text-[17px] font-medium leading-relaxed max-w-xl">
          We engineer decentralized systems that prioritize security, transparency, and high throughput. Our blockchain solutions are built for global scale and enterprise reliability.
        </p>
      </div>
    </div>
  );
...
const BlockchainPage: React.FC<BlockchainPageProps> = ({ onBackHome }) => {
  const [currentTestimonial, setCurrentTestimonial] = useState(0);

  const testimonials: TestimonialData[] = [
    {
      id: 'nathan',
      name: 'Nathaniel Vought',
      role: 'Head of Fintech',
      company: 'Aether Capital',
      text: "Mind Manthan's blockchain team was instrumental in developing our cross-border payment protocol. Their deep understanding of smart contract security saved us from several potential vulnerabilities during the audit phase. A truly world-class engineering team.",
      logo: (
    ...
    },
    {
      ...
      name: 'Sophia Chen',
      role: 'Founder',
      company: 'DecentraFlow',
      text: "We needed a custom Layer 2 solution that could handle millions of daily transactions. Mind Manthan delivered a robust architecture that outperformed our initial benchmarks. Their commitment to decentralized principles is unmatched.",
      logo: (
  ...
  const bcExpertise = [
    ...
    "NFT Marketplace Systems",
    "DEX & Liquidity Solutions",
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Banner Section - Synced with WebAppPage */}
      <section className="relative min-h-[500px] flex items-center overflow-hidden bg-gradient-to-r from-[#00055c] via-[#000d8c] to-[#0019ff] py-32 px-6 lg:px-12">
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[50%] h-full opacity-40 pointer-events-none">
          <svg width="100%" height="100%" viewBox="0 0 400 400" preserveAspectRatio="none">
            <pattern id="dotPatternBC" x="0" y="0" width="16" height="16" patternUnits="userSpaceOnUse">
              <circle cx="2" cy="2" r="1.5" fill="white" />
            </pattern>
            <rect width="100%" height="100%" fill="url(#dotPatternBC)" mask="url(#fadeMaskBC)" />
            <defs>
              <linearGradient id="fadeGradientBC" x1="0" y1="0" x2="1" y2="0">
                <stop offset="0%" stopColor="black" />
                <stop offset="100%" stopColor="white" />
              </linearGradient>
              <mask id="fadeMaskBC">
                <rect width="100%" height="100%" fill="url(#fadeGradientBC)" />
              </mask>
            </defs>
          </svg>
        </div>
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-white text-xl md:text-[28px] font-medium leading-tight max-w-3xl mb-14 opacity-95">
              Engineer trustless, secure, and highly efficient decentralized systems. We build the infrastructure for the next generation of the internet.
            </p>
            ...
            <button className="bg-[#e8edff] text-[#001fcc] px-10 py-4 rounded font-black text-sm uppercase tracking-widest hover:bg-white transition-all active:scale-95 shadow-2xl shadow-black/20">
              Discuss Your Web3 Roadmap
            </button>
          </div>
        </div>
      </section>

      {/* Benefits Section - Identical Structure to WebAppPage */}
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-stretch">
          <div className="flex-[1.2]">
            <h2 className="text-4xl md:text-[54px] font-black text-[#1a1b1f] leading-[1.05] tracking-tight mb-8">
              Decentralize your <br /> business logic
            </h2>
            <p className="text-gray-500 text-[18px] leading-relaxed mb-8 font-medium max-w-2xl">
              Traditional centralized systems are vulnerable and opaque. Our blockchain development services allow you to leverage the core tenets of Web3 to create systems that are practically immutable:
            </p>
            
            <ul className="space-y-4 mb-16">
              {[
                "Develop secure smart contracts with automated auditing and formal verification.",
                "Build cross-chain bridges to ensure your liquidity is never siloed.",
                "Implement private enterprise ledgers for secure internal supply chain tracking.",
                "Optimize gas usage to ensure your dApp remains cost-effective for users."
              ].map((item, idx) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
              {[
                { title: 'DeFi Mastery', desc: 'From yield aggregators to decentralized exchanges, we build protocols that move markets.' },
                { title: 'Secure Auditing', desc: 'Our "Security-First" approach involves multiple manual and automated audits before any mainnet launch.' },
                { title: 'Layer 2 Scaling', desc: 'Leverage ZK-rollups and Optimistic rollups to scale your application without sacrificing security.' },
                { title: 'DAO Governance', desc: 'Build community-led systems with sophisticated voting and proposal mechanisms.' }
              ].map((item, idx) => (
      ...
      {/* Process Section - Added to match WebAppPage Structure */}
      <section className="bg-white py-32 px-6 lg:px-12 border-t border-gray-50">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row-reverse gap-16 lg:gap-24 items-stretch">
          <div className="flex-[1.2]">
            <h2 className="text-4xl md:text-[54px] font-black text-[#1a1b1f] leading-[1.05] tracking-tight mb-8">
              Immunity by <br /> Architecture
            </h2>
            <p className="text-gray-500 text-[18px] leading-relaxed mb-12 font-medium max-w-2xl">
              Blockchain development requires a different mindset. We prioritize formal verification and rigorous testing to ensure that once deployed, your code is bulletproof.
            </p>
            
            <div className="space-y-8">
              {[
                { title: 'Security Audits', desc: 'Comprehensive manual and automated code reviews to identify vulnerabilities before deployment.' },
                { title: 'Optimized Gas', desc: 'Efficient smart contract logic that reduces transaction costs for your end users.' },
                { title: 'On-Chain Governance', desc: 'Flexible voting systems that allow your community to direct the protocol\'s future.' }
              ].map((item, idx) => (
                <div key={idx} className="flex gap-6 group">
                   <div className="w-14 h-14 bg-[#e8edff] rounded-2xl flex items-center justify-center text-[#001fcc] shrink-0 group-hover:bg-[#001fcc] group-hover:text-white transition-all duration-300">
                      {idx === 0 ? <Shield size={24} /> : idx === 1 ? <Zap size={24} /> : <Users size={24} />}
                   </div>
                   <div>
          ...
          <div className="flex-1 w-full min-h-[450px] flex relative">
            <div className="w-full rounded-[3rem] overflow-hidden shadow-2xl bg-gray-100 border border-gray-100">
              <img 
                src="https://images.unsplash.com/photo-1620321023374-d1a68fbc720d?auto=format&fit=crop&q=80&w=1200" 
                alt="Decentralized Database Visualization"
                className="w-full h-full object-cover"
              />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h3 className="text-4xl md:text-5xl font-black text-[#1a1b1f] tracking-tighter mb-6">
              Web3 Expertise Stacks
            </h3>
            <p className="text-gray-500 max-w-2xl mx-auto font-medium">
              We leverage the most powerful technologies in the blockchain ecosystem to build future-proof protocols.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: 'Ethereum & EVM', icon: <Cpu size={32} />, desc: 'Solidity and Vyper development for the world\'s most popular smart contract platform.' },
              { title: 'Rust & Solana', icon: <Zap size={32} />, desc: 'High-performance programming for ultra-low latency blockchain experiences.' },
              { title: 'Distributed Storage', icon: <Database size={32} />, desc: 'IPFS and Arweave integration for truly decentralized data persistence.' }
            ].map((service, idx) => (
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-start">
            <div className="flex-1 lg:sticky lg:top-40">
              <h2 className="text-4xl md:text-[54px] font-black text-[#1a1b1f] leading-[1.1] tracking-tighter mb-10">
                Protocols built <br /> for longevity
              </h2>
              <p className="text-gray-500 text-[19px] leading-relaxed max-w-md font-medium">
                We handle every technical layer of your Web3 platform. From gas-optimized smart contracts to intuitive dApp interfaces, we build for the future.
              </p>
            </div>

            <div className="flex-1 w-full">
              <div className="flex flex-col">
                {bcExpertise.map((expertise, idx) => (
                  <BlockchainTechItem key={expertise} title={expertise} index={idx} />
                ))}
              </div>
            </div>
          </div>
      ...
      <section className="bg-white py-32 px-6 border-t border-gray-100">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl md:text-[44px] font-black text-[#1a1b1f] leading-[1.1] tracking-tighter mb-12">
            Trusted by decentralized leaders
          </h2>
          ...
          <div className="flex-1 flex flex-col">
            <div className="bg-[#1a1b1f] p-12 md:p-16">
              <h2 className="text-4xl md:text-5xl lg:text-[64px] font-black text-white leading-[1.05] tracking-tighter">
                Scale Your Web3 Platform Today
              </h2>
            </div>
            <div className="bg-[#e8edff] flex-1 p-12 md:p-16">
              <p className="text-[#1a1b1f] text-lg font-medium mb-12 max-w-md leading-relaxed">
                Tell us about your project requirements. We usually provide a full technical roadmap and cost estimation within 48-72 hours.
              </p>
          ...
          <div className="flex-1 bg-white p-12 md:p-16">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea rows={4} placeholder="Describe your technical requirements and target blockchain (Ethereum, Solana, Polygon, etc.)..." className="w-full px-5 py-4 bg-white border border-gray-200 rounded-lg focus:border-[#001fcc] focus:ring-1 focus:ring-[#001fcc] outline-none transition-all resize-none"></textarea>
              </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:max-w-xl">
            <h3 className="text-4xl font-black text-[#1a1b1f] mb-8 tracking-tighter">
              World-Class Web3 Engineering.
            </h3>
            <ul className="space-y-6">
              {[
                'Global delivery model for 24/7 productivity',
                'Smart contract security at the core of development',
                'Deep expertise in decentralized liquidity models'
              ].map((item, idx) => (
          ...
          <div className="grid grid-cols-2 gap-8 lg:gap-16">
            <div className="text-center">
              ...
              <div className="text-xs font-black uppercase tracking-[0.2em] text-gray-400">Protocols Launched</div>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-black text-[#001fcc] mb-2 tracking-tighter">$500M+</div>
              <div className="text-xs font-black uppercase tracking-[0.2em] text-gray-400">TVL Secured</div>
            </div>
          </div>
        </div>
      </section>
