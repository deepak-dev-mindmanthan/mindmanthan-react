...
export const getSchema = (view: string, id?: number) => {
  const base = {
    ...
    "@type": "Organization",
    "name": "Mind Manthan",
    "url": "https://mindmanthansoftwaresolutions.com",
    "logo": "https://mindmanthansoftwaresolutions.com/assets/images/mindmanthan.webp",
    "sameAs": [
  ...
  if (view === 'home') {
    return [
      base,
      {
        ...
        "potentialAction": {
          "@type": "SearchAction",
          "target": "https://mindmanthansoftwaresolutions.com/blog?q={search_term_string}",
  ...
  if (seo?.schemaType === 'ProfessionalService') {
    return {
      ...
      "url": `https://mindmanthansoftwaresolutions.com${view === 'home' ? '' : '/' + view}`,
      "address": {
        "@type": "PostalAddress",
