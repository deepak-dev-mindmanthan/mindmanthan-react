...
import { getSEO, getSchema } from "./seoConfig";
            ...
            >
              <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
                <h2 className="text-3xl md:text-5xl lg:text-[52px] font-bold text-[#1a1b1f] leading-[1.1] mb-10 tracking-tight max-w-5xl">
                  ...
                  commercial goals of the client to deliver the highest business
                  value.
                </h2>
                <button
                  ...
                  <div className="flex flex-col justify-between max-w-md mb-12 md:mb-0">
                    <div>
                      <div className="flex justify-between items-start mb-16">
                        <span className="text-[24px] font-medium text-white/40">
                          03.
                        </span>
                      </div>
                    ...
                    <div className="mt-auto">
                      <span className="text-[14px] font-bold text-white/40 block mb-6 md:mb-0">
                        Lounge Project
                      </span>
                    </div>
                  </div>
                  <div className="flex-1 flex justify-center items-center relative">
                    <span className="hidden md:block absolute top-0 right-0 text-[14px] font-bold uppercase tracking-widest text-white/40">
                      Showcase
                    </span>
                    ...
                    <div className="w-full h-full flex justify-center items-center">
                      <div className="w-[320px] h-[500px] bg-white rounded-[2rem] shadow-2xl border border-gray-100 p-8 flex flex-col relative overflow-hidden group">
                        ...
                        <div className="flex gap-4 mb-8">
                          ...
                          <div className="flex-1 p-4 bg-gray-50 rounded-xl border border-gray-100">
                            <span className="text-3xl font-black block">0</span>
                            <span className="text-[10px] text-gray-400 font-bold uppercase">
                              Tech Debt
                            </span>
                          </div>
